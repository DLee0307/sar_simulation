...
LOG_DIR = f"{BASE_PATH}/sar_projects/NewDeepRL/TB_Logs" 
...
class RL_Training_Manager():
    ...
    # model_save_freq=2e3
    def train_model(self,model_save_freq=50,reward_check_freq=200,S3_upload_freq=1000,reset_timesteps=False,t_step_max=500e3):
